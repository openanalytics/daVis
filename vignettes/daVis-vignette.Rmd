...
features <- c(
	daVis:::getTopFeatures(input = topTableList, coef = "B.LvsP", 
		featuresIdVar = "ENTREZID", n = 10),
	daVis:::getFeatures(input = topTableList, 
		featuresIdVar = "ENTREZID")[10000:10009]
)
set.seed(123)
...
coefs <- c("B.LvsP", "L.LvsP", "B.PvsV", "L.PvsV")
features <- daVis:::getTopFeatures(input = res.limma, coef = "B.LvsP", 
